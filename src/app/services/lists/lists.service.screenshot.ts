        ...
        if (this.Locale.CurrentLanguage.localeFile == "de") {
            if (uuid == "2") {
                return List.fromBackend({
                    uuid: "2", name: "Muttis Geburtstags-Fete", created: Date.now(), order: 1, updated: Date.now() - (60 * 60 * 36 * 1000), items: [
                ...
                return List.fromBackend({
                    uuid: "3", name: "Putzplan", created: Date.now(), order: 2, updated: Date.now() - (60 * 60 * 24 * 7 * 1000), items: [
                        { uuid: "1", order: 0, item: "Brot", created: Date.now() - (60 * 60 * 4 * 1000) },
                        { uuid: "2", order: 1, item: "Butter", created: Date.now() - (60 * 60 * 2.1 * 1000) },
                        { uuid: "3", order: 2, item: "Eier", created: Date.now() - (60 * 60 * 9.2 * 1000) },
                        { uuid: "4", order: 3, item: "Milch", note: "Laktose-frei", created: Date.now() - (60 * 60 * 12.35 * 1000) },
                ...
                return List.fromBackend({
                    uuid: uuid, name: "Wocheneinkäufe", created: Date.now(), order: 0, updated: Date.now() - 3456 * 1000, items: [
                        { uuid: "1", order: 0, item: "Brot", created: Date.now() - (60 * 60 * 4 * 1000) },
                        { uuid: "2", order: 1, item: "Butter", created: Date.now() - (60 * 60 * 2.1 * 1000) },
            ...
            if (uuid == "2") {
                return List.fromBackend({
                    uuid: "2", name: "Mom's birthday party", created: Date.now(), order: 1, updated: Date.now() - (60 * 60 * 36 * 1000), items: [
                ...
                return List.fromBackend({
                    uuid: "3", name: "Cleaning plan", created: Date.now(), order: 2, updated: Date.now() - (60 * 60 * 24 * 7 * 1000), items: [
                        { uuid: "1", order: 0, item: "bread", created: Date.now() - (60 * 60 * 4 * 1000) },
                        { uuid: "2", order: 1, item: "butter", created: Date.now() - (60 * 60 * 2.1 * 1000) },
                        { uuid: "3", order: 2, item: "8 eggs", created: Date.now() - (60 * 60 * 9.2 * 1000) },
                        { uuid: "4", order: 3, item: "milk", note: "lactose-free", created: Date.now() - (60 * 60 * 12.35 * 1000) },
                ...
                return List.fromBackend({
                    uuid: "1", name: "Weekly groceries", created: Date.now(), order: 0, updated: Date.now() - 3456 * 1000, items: [
                        { uuid: "1", order: 0, item: "bread", created: Date.now() - (60 * 60 * 4 * 1000) },
                        { uuid: "2", order: 1, item: "butter", created: Date.now() - (60 * 60 * 2.1 * 1000) },
                        { uuid: "3", order: 2, item: "8 eggs", created: Date.now() - (60 * 60 * 9.2 * 1000) },
                        { uuid: "4", order: 3, item: "milk", note: "lactose-free", created: Date.now() - (60 * 60 * 12.35 * 1000) },
