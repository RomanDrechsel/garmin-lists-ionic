...
export const routes: Routes = [
    ...
    },
    {
        path: "lists",
        loadComponent: () =>
            import("./pages/lists/lists/lists.page").then((m) => m.ListsPage),
    },
    {
    ...
    },
    {
        path: "settings",
        loadComponent: () =>
            import("./pages/settings/settings/settings.page").then((m) => m.SettingsPage),
    },
    {
        path: "settings/logs",
        loadComponent: () =>
            import("./pages/settings/showlogs/showlogs.page").then((m) => m.ShowlogsPage),
    },
    {
    ...
    },
    {
        path: "appinfos",
        loadComponent: () =>
            import("./pages/appinfos/appinfos.page").then((m) => m.AppinfosPage),
    },
